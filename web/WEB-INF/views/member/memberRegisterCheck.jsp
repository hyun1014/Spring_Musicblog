...
<div class="container" style="padding:50px;">
    <c:if test="${empty error}"><h3>Member Registered</h3></c:if>
    <c:if test="${not empty error}">
        <h3>Member Register failed</h3>
        <h4>${error}</h4>
    </c:if>
    <ul>
        <li>이름: ${mem.name}</li>
    ...
    <a class="no_linkdecoration" href="${pageContext.request.contextPath}/member/">Go to member list</a>
</div>
