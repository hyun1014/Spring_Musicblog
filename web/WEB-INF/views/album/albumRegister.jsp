...
<div class="container" style="padding:50px;">
    <h3>Album Register</h3>
    <h6>* 표시는 필수 항목입니다.</h6>
    <form:form action="${pageContext.request.contextPath}/album/registercheck" method="post" modelAttribute="album">
        *이름: <form:input path="title" required="required"/><br/>
